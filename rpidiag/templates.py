...
TEMP_WIDTH = len(TEMP_TEXT)
VOLTS_WIDTH = len(VOLTS_TEXT)
CLOCK_WIDTH = len(CLOCK_TEXT)
THROTTLED_WIDTH = len(THROTTLED_TEXT)
...
HEADER_MID = (
    f"{VER_FRAME}{TIME_TEXT}"
    f"{VER_FRAME}{TEMP_TEXT}"
    f"{VER_FRAME}{VOLTS_TEXT}"
    f"{VER_FRAME}{CLOCK_TEXT}"
    f"{VER_FRAME}{THROTTLED_TEXT}"
    f"{VER_FRAME}\n"
)
